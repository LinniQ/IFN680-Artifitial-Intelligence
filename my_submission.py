...
def warped_data(rotation,variation,input_dim,warped_size,file_name):
    ...
    # to enhance the probobility of choosing each images, the other 40,000 is chosen from the reversed order
...
def exp2():
    ...
    file2 = warped_data(rotate_h, strength_h, input_dim, warped_size,file1)
    ...
    # to ensure the size of warped sample meet the requirement (100,000 samples)
    print('Warped Sample Size is ',x_train[0].shape)
...
def exp3():
    ...
    file_E = warped_data(rotate_e, strength_e, input_dim, warped_size,file1)
    ...
    # call method warped_data to warp the 100,000 image 
    # the rotation degree and parameter for strength can be changed if needed within experimental 3
    file_H = warped_data(rotate_h, strength_h, input_dim, warped_size,file1)
...
if __name__=='__main__':
    ...
    warped_size = 100000 # the sample size of warped images
    for i in range(10):
        epochs = 1
        batch_size = 128
        #exp1()
