...
class PatternPosePopulation(population_search.Population):
    ...
    def evaluate(self):
        ...
        #imf = pattern_utils.pat_image(pat_list, pose_list, imf=None)
        #imd = pattern_utils.dist_image(imf)
        
        
        
        for i in range(self.n):
            #variable indiv_cost is a tuple storing (cost, three position of vertices in array) of each pattern
            #self.pat is an object of pattern_utils and used to call evaluate method in pattern_utils.py
            ...
            # assign first element of indiv_cost which is the cost of each pattern in self.C
